...
### 基本構文
ISODate(時間)
mongoのISODateはGMT(グリニッジ標準時)で表現されています。ISODateの末尾に"+09:00"と書くと日本時間として解釈されます。

### 具体例
2016年10月22日に挿入されたデータを抽出する
(2016/10/22 00:00以上 〜 2016/10/22 00:00未満という条件を指定しています。)
```
